...
return [
    ...
    /**
     * Public Key: Your Rave publicKey. Sign up on https://ravepay.co to
     * get one from your settings page.
     */
    'publicKey' => env('RAVE_PUBLIC_KEY'),

    /**
     * Secret Key: Your Rave secretKey. Sign up on https://ravepay.co to
     * get one from your settings page.
     */
    ...
    /**
     * Prefix: This is added to the front of your transaction reference
     * numbers.
     */
    'prefix' => env('RAVE_PREFIX', 'rave'),

    /**
     * The id of the premium subscription plan.
     */
    'payment_plan' => null
